        ...
        <div className="contentHeader">
          <div className="contentContainer">
            ...
            <div className="categories">
              <NavLink to="/news/1" className="authBut">
              ...
              <NavLink to="/bookmarks/1" className="authBut">
                <div className="category">
                  <div className="contentAuth">
                    <svg
                      className="icon"
              ...
              <NavLink to="/about" className="authBut">
                <div className="category">
                  <div className="contentAuth">
                    <svg
                      className="icon"
